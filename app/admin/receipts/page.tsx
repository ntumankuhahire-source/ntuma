...
export default function ReceiptsPage() {
  ...
  // Auto-generate Hash Verification QR URL on input change
  useEffect(() => {
  ...
  const handleReset = () => {
    const newReceiptNo = `NT-2026-${Math.floor(1000 + Math.random() * 9000)}`
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs mb-6 flex flex-wrap items-center justify-between gap-4 no-print">
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-800 bg-emerald-50 border border-emerald-200 px-3 py-1.5 rounded-lg">
              <ShieldCheck className="w-4 h-4 text-emerald-600" /> HMAC SHA-256 Verified
            </span>
          </div>
          ...
          <div className="lg:col-span-5 space-y-6 no-print">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Product items purchased..."
                  />
                </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
              <div className="flex items-center gap-2 mb-4 pb-2 border-b border-slate-100">
                ...
                <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider">
                  4. Issuer / Owner Info (Hardcoded Defaults)
                </h2>
              </div>
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 pt-1">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-xs border border-slate-300 rounded-lg bg-slate-50 font-mono focus:ring-2 focus:ring-emerald-600 outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-[11px] font-semibold text-slate-600 mb-1">
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-xs border border-slate-300 rounded-lg bg-slate-50 text-[11px] focus:ring-2 focus:ring-emerald-600 outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-[11px] font-semibold text-slate-600 mb-1">
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-xs border border-slate-300 rounded-lg bg-slate-50 focus:ring-2 focus:ring-emerald-600 outline-none"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
              <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wider">
                    5. Dynamic SHA-256 QR Verification URL
                  </h2>
                </div>
                <button
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1">
                  Deterministic Verification Link (Auto-Generated)
                </label>
                <input
                  type="text"
                  readOnly
                  value={formData.qrPayload}
                  className="w-full px-3 py-2 text-xs font-mono border border-slate-300 rounded-lg bg-slate-50 text-slate-800 outline-none select-all"
                />
                <p className="text-[11px] text-slate-500 mt-1.5">
                  Contains parameters &amp; 10-character SHA-256 HMAC digital signature for database-free verification.
                </p>
              </div>
            </div>
